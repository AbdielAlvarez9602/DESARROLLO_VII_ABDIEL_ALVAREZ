...
$misAmigos = ["Alexander Vargas", "Melqui Diaz", "Joaquin Gonzalez"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Luis Herrera", "Carlos Medina"); // Reemplaza las comillas vacías con los nombres de tus amigos
