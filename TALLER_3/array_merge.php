...
$misComidas = ["pizza", "sushi", "hamburguesa"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["tacos", "paella", "ensalada"]; // Reemplaza con las comidas favoritas de tu amigo
