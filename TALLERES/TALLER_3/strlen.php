...
$miNombre = "Abdiel Alvarez"; // Reemplaza esto con tu nombre completo
...
$pais = "Panama"; 
$categoriaPais = categorizarLongitud($pais);
echo "<br>El nombre del país '$pais' es considerado $categoriaPais.";
?>
