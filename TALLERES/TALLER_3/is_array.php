...
$miArray = ["manzana", "naranja", "plátano"];
$miString = "Esto es una cadena";
$miNumero = 42;

echo "<br>Resultados del ejercicio:<br>";
echo '¿mi arrelo es un array? ' . (is_array($miArray) ? "Sí" : "No") . "<br>";
echo '¿mi cadena es un array? ' . (is_array($miString) ? "Sí" : "No") . "<br>";
echo '¿mi numero es un array? ' . (is_array($miNumero) ? "Sí" : "No") . "<br>";
